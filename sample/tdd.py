...
class TestStringsExamples(unittest.TestCase):
    def test_concat_strings(self):
        string1 = "hola"
        string2 = "adios"
        result = TextExamples.concat_strings(string1, string2)
        assert result=="holaadios"

    def test_concat_int_string(self):
        str1 = 1
        str2 = "adios"
        self.assertRaises (TypeError,TextExamples.concat_strings,str1,str2)
    ...
    def test_concat_two_strings(self):
        str1= "Espana"
        str2= "Belgica"
        result = TextExamples.concat_strings(str1, str2)
    ...
    def test_concat_three_strings(self):
        ...
        str2 = "Belgica"
        str3="Holanda"
        result = TextExamples.concat_strings(str1, str2,str3)
    ...
    def test_concat_four_strings(self):
        ...
        str3="Holanda"
        str4= "Alemania"
        result = TextExamples.concat_strings(str1, str2,str3,str4)
    ...
    def test_concat_five_strings(self):
        ...
        str4 = "Alemania"
        str5= "Portugal"
        result = TextExamples.concat_strings(str1, str2, str3, str4,str5)
    ...
    def test_concat_six_strings(self):
        ...
        str5= "Portugal"
        str6= "Francia"
        result = TextExamples.concat_strings(str1, str2, str3, str4,str5,str6)
    ...
    def test_concat_seven_strings(self):
        ...
        str6 = "Francia"
        str7 = "Italia"
        result = TextExamples.concat_strings(str1, str2, str3, str4, str5, str6,str7)
    ...
    def test_concat_eight_strings(self):
        ...
        str7 = "Italia"
        str8= "Grecia"
        result = TextExamples.concat_strings(str1, str2, str3, str4, str5, str6,str7,str8)
    ...
    def test_concat_nine_strings(self):
        ...
        str8= "Grecia"
        str9= "Serbia"
        result = TextExamples.concat_strings(str1, str2, str3, str4, str5, str6,str7,str8,str9)
    ...
    def test_concat_ten_strings(self):
        ...
        str9 = "Serbia"
        str10 = "Rumania"
        result = TextExamples.concat_strings(str1, str2, str3, str4, str5, str6, str7, str8, str9,str10)
    ...
    def test_concat_eleven_strings(self):
        ...
        str10 = "Rumania"
        str11 = "Lituania"
        self.assertRaises(TypeError, TextExamples.concat_strings,str1, str2, str3, str4, str5, str6, str7, str8, str9,str10,str11)
